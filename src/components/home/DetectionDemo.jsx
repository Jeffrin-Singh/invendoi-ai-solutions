...
<<<<<<< HEAD
        ...
        image: "/2.jpg",
        meta: { feed: "CCTV • Secure Zone", latency: "< 320ms", mode: "On-prem + Edge" },
        boxes: [
            { x: 8, y: 40, w: 14, h: 28, label: "Car #1 | Speed: 62 km/h", conf: 0.93, color: "from-yellow-400 to-yellow-600" },   // far left
            { x: 25, y: 48, w: 18, h: 32, label: "Vehicle | Confidence: 96%", conf: 0.96, color: "from-yellow-400 to-yellow-600" },   // center close
            { x: 45, y: 45, w: 16, h: 30, label: "Car", conf: 0.94, color: "from-yellow-400 to-yellow-600" },   // mid lane
            { x: 68, y: 50, w: 18, h: 32, label: "Car", conf: 0.95, color: "from-yellow-400 to-yellow-600" },   // right close
        ],
    },
    {
        key: "kerala-defence",
        title: "Kerala Defence Monitoring",
        subtitle: "Perimeter security • Real-time alerts",
        image: u("photo-1516321497487-e288fb19713f"),
        meta: { feed: "Secure Perimeter", latency: "< 300ms", mode: "On-prem" },
        boxes: [
            { x: 24, y: 36, w: 18, h: 34, label: "Person", conf: 0.95, color: "from-cyan-400 to-indigo-500" },
            { x: 52, y: 42, w: 24, h: 28, label: "Intrusion Risk", conf: 0.89, color: "from-rose-500 to-amber-400" },
        ],
    },
    {
        key: "wildlife",
        title: "Elephant Detection Early Warning",
        ...
        boxes: [
            { x: 32, y: 35, w: 42, h: 28, label: "Elephant", conf: 0.82, color: "from-emerald-400 to-cyan-400" },
        ],
    },
    {
=======

...
export default function ProjectCard({ project }) {
    ...
    return (
        ...
        >
            <MagicBento
                glowColor="34, 211, 238" // Cyan for projects
                enableStars={true}
                enableSpotlight={true}
                clickEffect={true}
                className="rounded-[32px]"
            >
                <div className="glass h-full flex flex-col overflow-hidden border-white/5 bg-white/[0.02] hover:bg-white/[0.04] transition-all">
